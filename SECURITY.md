...
- **Local use (typical)**: If the MCP server runs on the **same machine** as the client (HTTP on `127.0.0.1`), **transport encryption is not this project’s job** and is usually unnecessary—the process boundary is your OS and host app. No TLS or “end-to-end encryption” layer is provided or required for that setup.
