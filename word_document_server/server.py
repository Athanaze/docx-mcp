...
from word_document_server.operations import protection, pdf, preview
...
def register_tools():
    ...
    def get_document_info(filename: str):
        """Get document properties, word count, block count, etc."""
    ...
    def get_document_text(filename: str, include_indices: bool = True):
        ...
        return content.get_document_text(filename=filename,
    ...
    def get_document_outline(filename: str):
        ...
        return content.get_document_outline(filename=filename)
    ...
    @mcp.tool(annotations=ToolAnnotations(title="Encrypt Document"))
    def encrypt_document(filename: str, password: str):
        """Encrypt a Word document with a password."""
        return protection.encrypt_document(filename=filename, password=password)

    @mcp.tool(annotations=ToolAnnotations(title="Decrypt Document"))
    def decrypt_document(filename: str, password: str):
        """Decrypt a password-protected Word document."""
        return protection.decrypt_document(filename=filename, password=password)
